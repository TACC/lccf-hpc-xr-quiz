...
namespace zSpace.zView
{
    public partial class ZView : MonoBehaviour
    {
        ...
        /// <summary>
        /// The render texture format to use for color render textures. Must be
        /// a color render texture format that supports the R, G, B, and A
        /// channels.
        /// </summary>
        /// <remarks>
        /// Setting this to Default will use the same color texture format that
        /// is used internally by zView.
        /// </remarks>
        public RenderTextureFormat ColorRenderTextureFormat =
            RenderTextureFormat.Default;

        /// <summary>
        /// Enables using the ZCamera camera to render zView color images when
        /// Unity's Universal Render Pipeline (URP) is being used.
        /// </summary>
        /// <remarks>
        /// If this is set to false and URP is being used, then the
        /// URPColorCamera field must be set to valid camera.
        /// </remarks>
        public bool EnableUsingZCameraCameraAsURPColorCamera = true;

        /// <summary>
        /// The camera that zView should use for rendering color images when
        /// Unity's Universal Render Pipeline (URP) is being used and the
        /// ZCamera camera is not being used for rendering color images.
        /// </summary>
        /// <remarks>
        /// This camera is only used if URP is being used and the
        /// UseZCameraCameraAsURPColorCamera field is set to false.
        /// </remarks>
        public Camera URPColorCamera = null;
        ...
        /// <summary>
        /// If enabled, attempt to automatically find the zView augmented
        /// reality mode Universal Render Pipeline (URP) renderer, if URP is
        /// being used. If not enabled and URP is being used, then the index of
        /// the renderer to use must be specified via the
        /// ARModeURPRendererIndex field.
        /// </summary>
        public bool ARModeEnableURPRendererAutoFind = true;

        /// <summary>
        /// The index of the zView augmented reality mode Universal Render
        /// Pipeline (URP) renderer within the array of renderers for the
        /// active Universal Render Pipeline asset. Only needed if URP is being
        /// used and the ARModeEnableURPRenderAutoFind field is set to false.
        /// </summary>
        public int ARModeURPRendererIndex = -1;
