...
namespace zSpace.zView
{
    public class BoxMask : MonoBehaviour
    {
        ...
        public void SetRenderQueue(int renderQueue)
        {
            ...
            {
                _depthMaskMaterial.renderQueue = renderQueue;
            }
        }
        
        public void SetDepthMaskMaterial()
        {
            if (_meshRenderer != null && _meshRenderer.material != null)
            {
                _meshRenderer.material = _depthMaskMaterial;
            }
        }

#if ZSPACE_UNITY_RENDER_PIPELINE_UNIVERSAL
        public void SetURPLitMaterial()
        {
            if (_meshRenderer != null && _meshRenderer.material != null)
            {
                _meshRenderer.material = _urpLitMaterial;
            }
        }
#endif
        ...
        private void CreateMesh()
        {
            ...
            {
                Debug.LogError("Failed to find the Universal Render Pipeline/Lit shader.");
            }
            else
            {
        ...
        private Material _depthMaskMaterial = null;
#if ZSPACE_UNITY_RENDER_PIPELINE_UNIVERSAL
        private Material _urpLitMaterial = null;
#endif
